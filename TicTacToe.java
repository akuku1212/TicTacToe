...
public class TicTacToe{
    ...
    public boolean move(int x, int y) {
        if(board[x][y] == " X " || board[x][y] == " O ") return false;
        return true;
    }
    ...
    public static String checkWhoWon() {
        if ((board[0][0] == " X " && board[0][1] == " X " && board[0][2] == " X ") || 
            ...
            (board[2][0] == " X " && board[1][1] == " X " && board[0][2] == " X ")) return playerX;
            ...
            (board[2][0] == " O " && board[1][1] == " O " && board[0][2] == " O ")) return playerO;
        else return null;
    }
   ...
   public static void main(String[] args) {
        ...
        while(game.checkWhoWon()== null){
            ...
            while(xy == "no"){
                ...
                else System.out.println("Move is not allowed, repeat your move."); 
            }
            ...
            while(ab=="no"){
                ...
                int xO = Integer.parseInt(moveO.substring(0,1));
                int yO = Integer.parseInt(moveO.substring(2));
                if(game.move(xO, yO)== true){
                    board[xO][yO]=" O ";
                    ab="yes";
                }
                else System.out.println("Move is not allowed, repeat your move.");
